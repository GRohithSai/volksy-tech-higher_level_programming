...
INSERT INTO cities values(1, 1, "San Fransico"), (2, 1, "San Jose"), (4, 2, "Page"), (6, 3, "Paris"), (7, 3, "Houston"), (8, 3, "Dallas"));
SELECT id, name FROM cities UNION SELECT id, name FROM states WHERE name = "California";
